...
RSpec.describe RecipeFood, type: :model do
  before(:each) do
    @user = User.create(name: 'Belay', email: 'borntodie2129@gmail.com', password: '123456')
    @food = Food.create(name: 'Pizza', measurement_unit: 'gram', price: 15, quantity: 2, user_id: @user.id)
    @recipe = Recipe.create(name: 'Pizza Recipe', description: 'Description to make pizza',
                            preparation_time: 15, cooking_time: 30, user_id: @user.id, public: false)
